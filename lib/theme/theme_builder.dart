...
class ThemeBuilder {
  static ThemeData build(BuildContext context, String themeName,
      {String fontFamily}) {
    return _getTheme(context, themeName, MyColors.primary,
  ...
  static ThemeData _generateBasicTheme(
    ...
    final _textTheme = _defaultTextTheme.copyWith(
      ...
      bodyText1: _themeData.textTheme.bodyText1.regular
          .size(16)
          .textColor(_isDark ? MyColors.text.combineWhite40 : MyColors.text),
      bodyText2: _themeData.textTheme.bodyText2.regular.size(14).textColor(
          _isDark ? MyColors.description.combineWhite40 : MyColors.description),
      button: _themeData.textTheme.button.semiBold,
      caption: _themeData.textTheme.caption.size(12),
      overline: _themeData.textTheme.overline.size(10),
    );
    ...
    return ThemeData(
      ...
      colorScheme:
        ...
        secondaryVariant:
            _isDark ? _primaryColor.combineWhite40 : _primaryColor.shade700,
      ),
      ...
      errorColor: _isDark
          ? _themeData.errorColor.combineWhite40
          : _themeData.errorColor,
      unselectedWidgetColor: _isDark
          ? MyColors.unselected_item_color.combineWhite40
          : MyColors.unselected_item_color,
      toggleableActiveColor:
          _isDark ? _primaryColor.combineWhite40 : _primaryColor,
      textSelectionTheme: TextSelectionThemeData(
        selectionHandleColor:
            _isDark ? _primaryColor.combineWhite40 : _primaryColor,
        cursorColor: _isDark ? _primaryColor.combineWhite40 : _primaryColor,
        selectionColor: _isDark
            ? _primaryColor.combineWhite70
            : _primaryColor.combineWhite40,
      ),
      textTheme: _textTheme,
      splashColor: _primaryColor.shade100,
      hintColor:
          _isDark ? MyColors.hintColor.combineWhite40 : MyColors.hintColor,
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        unselectedItemColor: _isDark
            ? MyColors.description.combineWhite40
            : MyColors.description,
        selectedItemColor:
            _isDark ? _primaryColor.combineWhite40 : _primaryColor,
        backgroundColor: _isDark ? null : Colors.white,
        unselectedLabelStyle: _themeData.textTheme.overline.medium.size(10),
        selectedLabelStyle: _themeData.textTheme.overline.medium.size(10),
        type: BottomNavigationBarType.fixed,
      ),
      scaffoldBackgroundColor: _isDark ? null : Colors.white,
  ...
  static ThemeData _getTheme(
      BuildContext context, String themeName, Color primaryColor,
      {String fontFamily}) {
    switch (themeName) {
      case 'dark':
  ...
  static ThemeData _lightTheme(BuildContext context, Color primaryColor,
      {String fontFamily}) {
  ...
  static ThemeData _darkTheme(BuildContext context, Color primaryColor,
      {String fontFamily}) {
    return _generateBasicTheme(
      context,
      primaryColor?.materialColor,
