...
class _DateTimeInputAreaState extends State<DateTimeInputArea> {
  ...
  void initState() {
    ...
    if (widget.initialDate != null) {
      _initialValue = widget.dateFormatDisplay != null ? widget.dateFormatDisplay.format(widget.initialDate) : DateFormat.yMMMd().format(widget.initialDate);
    }
  }
  ...
  void didUpdateWidget(DateTimeInputArea oldWidget) {
    ...
    if (_selectedDate != null && widget.newSelectedDate != null && _selectedDate != widget.newSelectedDate) {
  ...
  _updateText() {
    final dateFormatted = widget.dateFormatDisplay?.format(_selectedDate) ?? _selectedDate.format('dd/MM/yyyy');
    _controller
      ..text = dateFormatted
      ..selection = TextSelection.fromPosition(TextPosition(offset: _controller.text.length, affinity: TextAffinity.upstream));
  }
}
